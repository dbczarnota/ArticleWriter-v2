// Inline SVG icons (Lucide-style). All accept SVGProps for sizing/styling.
...
export const RadioTowerIcon = (p: IconProps) => (
  <svg {...base} {...p}>
...
export const BroadcastIcon = (p: IconProps) => (
  <svg {...base} {...p}>
    ...
    <path d="M19.1 4.9C23 8.8 23 15.2 19.1 19" />
  </svg>
);
...
// Brand icons — filled, exact paths
