...
vi.mock("../i18n", () => ({
  useT: () => ({
    discovery: {
      ...
      topic: { sources: "", write: "", openArticle: "", loading: "", empty: "", emptyHint: "", backToTopics: "", firstSeen: "", firstSeenShort: "", lastActivity: "", lastActivityShort: "", statusLabel: "", itemsCount: "", writeArticle: "", itemsShort: "", error: "", toggleSources: "", dismiss: "", restore: "" },
      item: { empty: "", emptyHint: "", uncategorized: "", colItem: "", colCategories: "", colSeen: "" },
