...
const SECTION_IDS = ["podstawowe", "modele", "wyszukiwanie", "zrodla", "media", "wytyczne", "html", "stance", "tytuly", "przyklady", "szablony", "szablony-obrazkow", "discovery", "streamy", "integracje"] as const;
